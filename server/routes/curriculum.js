...
// Learning analytics
// ===========================================================================
router.get('/analytics', requirePermission('learning.analytics'), wrap(async (_req, res) => {
...
router.get('/learners/:id', requirePermission('learning.analytics'), wrap(async (req, res) => {
