...
const KIND_ICON = {
  ...
  lesson: 'book', badge: 'award', level: 'zap', connection: 'users',
  announcement: 'megaphone', moderation: 'shield', account: 'user', invite_used: 'ticket',
    ...
    try {
      ...
      list.innerHTML = data.notifications.length
        ...
        : `<div class="card">${emptyState({
          ...
          text: 'New messages, replies, reactions, badges and announcements show up here.'
        })}</div>`;
      refreshCounts();
    } catch (err) {
